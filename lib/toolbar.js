...
(function () {
  ...
  function eraser() {
    return window.__pdfTranslateErase;
  }
  ...
  const ERASE_ICON =
    "url(\"data:image/svg+xml;charset=UTF-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3E%3Cpath d='M9.5 1.9a1.6 1.6 0 0 1 2.3 0l2.3 2.3a1.6 1.6 0 0 1 0 2.3l-6 6H5.3l-3.4-3.4a1.6 1.6 0 0 1 0-2.3zM7 4.4 3.3 8.1l3.4 3.4h1.4l1.8-1.8z'/%3E%3Cpath d='M8.5 13.5H15V15H8.5z'/%3E%3C/svg%3E\")";
  ...
  const STYLES = [
    ...
    '}',
    '#pdfTranslateErase::before {',
    '  -webkit-mask-image: ' + ERASE_ICON + ';',
    '          mask-image: ' + ERASE_ICON + ';',
    '}',
  ...
  function setTool(tool) {
    ...
    try {
      ...
      const eraseTool = eraser();
      if (eraseTool) {
        eraseTool.setActive(tool === ERASE);
      }
  ...
  const BUTTONS = [
    ...
    { tool: ERASE, id: 'pdfTranslateErase' },
  ];
